...
with col_trend:
    ...
    st.plotly_chart(fig2, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
...
with col_pie:
    if 'Insurance_Carrier' in filtered.columns:
        ...
        st.plotly_chart(fig3, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
...
with col_proc:
    if 'code' in filtered.columns:
        ...
        st.plotly_chart(fig_proc, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
...
with col_prov:
    if 'Doctor' in filtered.columns:
        ...
        st.plotly_chart(fig_prov, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
...
with col_cat:
    if 'CPT_Category' in filtered.columns:
        ...
        st.plotly_chart(fig5, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
...
with col_cpt:
    if 'code' in filtered.columns:
        ...
        st.plotly_chart(fig_cpt, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
...
if 'code' in filtered.columns and 'Year' in filtered.columns:
    ...
    with col_yr1:
        ...
        st.plotly_chart(fig_yr1, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
    ...
    with col_yr2:
        ...
        st.plotly_chart(fig_yr2, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
...
with col_var:
    if 'Variance' in filtered.columns:
        ...
        st.plotly_chart(fig6, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
...
with col_doc:
    if 'Doctor' in filtered.columns:
        ...
        st.plotly_chart(fig7, st.dataframe(filtered[show_cols].head(500), width='stretch', height=330)
